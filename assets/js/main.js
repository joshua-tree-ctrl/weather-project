...
$.ajax({
    ...
    $('h1').html(weather.name + " " + weather.main.temp + " " + weather.main.temp + " " + weather.main.temp_max + " " + weather.main.temp_min  );
    $('.weather__icon').append("<img src=\"http://openweathermap.org/img/wn/"  + weather.weather[0].icon + "@2x.png\" alt=\"image weather\">");
